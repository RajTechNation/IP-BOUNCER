...
print('''\033[1;32;40m \n
 ...
 |___| |_|       |____/   \___/   \___/  |_| \_|  \____| |_____| |_| \_\
    ...
    FROM YOUTUBER (RAJ TECH NATION)
''')
print("\033[1;40;31m https://www.youtube.com/channel/UC6SLxEboOGU5F_o4bduyO3g?sub_confirmation=1\n")
...
os.system("service tor start")
x = input("[+] Interval of time to change Ip in Sec [MAXIMUM = 30] = ")
